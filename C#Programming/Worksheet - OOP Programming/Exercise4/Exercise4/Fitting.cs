...
namespace Exercise4
{
    public class Fitting
    {
        ...
        public void Record()
        {
            ...
            OleDbCommand command = new OleDbCommand("INSERT into TyresDb (CarReg,FittingDate,TyreType,NumOfTyres,CostOfFitting) values('" + _carReg + "','" + _fittingDate + "','" + _tyreType + "','" + _numOfTyres + "','" + _costOfFitting + "')", conn);
            try
            {
            ...
            MessageBox.Show("The fitting has been recorded.");
            return;
        }
    }
}
